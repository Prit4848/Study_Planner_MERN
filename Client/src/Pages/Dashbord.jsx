    ...
    <>
      ...
      <div className="container mx-auto p-4 mt-10 flex flex-col gap-6">
        <div className="bg-white shadow-md rounded-lg p-6 flex-1">
          ...
          <p className="text-base lg:text-lg mb-6">Welcome, {user.username}</p>
          ...
          <div className="mb-6">
            <label htmlFor="completion-filter" className="block text-sm font-medium text-gray-700">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 flex-1">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl lg:text-2xl font-semibold">Your Study Plans</h2>
            <Link to="/Plan/Create" className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
              Create New Plan
            </Link>
          </div>

          {filteredPlans.length === 0 ? (
            <p className="text-gray-600">No study plans match the selected filters.</p>
          ) : (
                  ...
                  <li key={index} className="bg-gray-100 p-4 rounded-lg shadow">
                    <div className="flex flex-col lg:flex-row justify-between">
                      ...
                      <div className="flex gap-2 mt-2 lg:mt-0">
                        ...
                        <Link to="/Plan/Edit" state={{ plan }} className="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600">
                          Edit
                        </Link>
                    ...
                    <p className="text-sm text-gray-700 mt-1">{completed}/{total} tasks completed</p>
                  </li>
                );
              })}
            </ul>
        ...
        <div className="bg-white shadow-md rounded-lg p-6 flex-1">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/Goal/Create" className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
              Create New Goal
            </Link>
          </div>
          ...
          <ul className="space-y-4">
            {goal.map((goal, index) => (
              <li key={index} className="bg-gray-100 p-4 rounded-lg shadow">
                <div className="flex flex-col lg:flex-row justify-between">
                  <h3 className="text-lg lg:text-xl font-semibold">{goal.goalTitle}</h3>
                  <div className="flex gap-2 mt-2 lg:mt-0">
                ...
                <p className="text-sm text-gray-700 mt-1">
                  Due Date: {new Date(goal.dueDate).toLocaleDateString("en-US", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                  })}
                </p>
                <p className="text-sm text-gray-700 mt-1">Priority: {goal.priority}</p>
              </li>
            ))}
          </ul>
        </div>
